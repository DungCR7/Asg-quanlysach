...
public class Tools {
    ...
    public void Filter_by_Author() {
        ...
        int count = 0;
        for (BookInformation book : Main.books) {
    ...
    public void Order_by_price_desc() {
        ...
        List<BookInformation> list = new ArrayList<BookInformation>(Main.books);

        //săp xếp theo giá giảm dần
        Collections.sort(list, new Comparator<BookInformation>() {
            @Override
